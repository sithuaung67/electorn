      ...
      <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
          ...
          <div class="kt-subheader__breadcrumbs">
            ...
            <a href="" class="kt-subheader__breadcrumbs-link">Tour Group </a>
              <span class="kt-subheader__breadcrumbs-separator"></span>
              ...
              <div class="row justify-content-center">
                <div class="col-md-10">
                  <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.tour_group.update',$tour_group->tour_group_id) }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      @method('post')
                       ...
                       <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="tour_leader_id" id="tour_leader_id" aria-describedby="" placeholder="" style="height: auto;">
                              <option value="{{$tour_group->tour_leader_id}}">{{$tour_group->tour_leader->name}}</option>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="package_id" id="package_id" aria-describedby="" placeholder="" style="height: auto;">
                              <option value="{{$tour_group->package_id}}">{{$tour_group->package->package_name_mm }}({{$tour_group->package->tour_code}})</option>
