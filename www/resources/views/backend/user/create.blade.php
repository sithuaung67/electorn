...
@endsection
@section('title','Member Account Create')
@section('content')
              ...
              <div class="row justify-content-center">
                <div class="col-md-10">
                  <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.users.store') }}" method="POST"  autocomplete="off" >
                      @csrf
                      <div class="kt-portlet__body">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Email  </label>
                            <input type="email" class="form-control" name="email" aria-describedby="" placeholder="" value="{{ old('email') }}">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" aria-describedby="" placeholder=" " value="{{ old('password') }}">
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="roles" id="users">
