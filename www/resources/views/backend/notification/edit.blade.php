              ...
              <div class="row justify-content-center">
                <div class="col-md-8">
                  <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.notification.update',$notification->notification_id) }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      @method('post')
                      <div class="kt-portlet__body">
                       <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Title</label>
                            <input type="text" class="form-control" name="title" id="title" aria-describedby="" placeholder="" style="height: auto;" value="{{ $notification->title }}" required="required">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Message</label>
                            <textarea class="form-control" name="message" id="message" aria-describedby="" placeholder="" required="required" style="height: 200px;">{!! $notification->message !!}</textarea>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <img id="image_one" src="../../../../uploads/notification/{{$notification->image}}" width="100%" height="200" />
                            </div>
                          </div>
                        <div class="col-md-12">
                            <div class="row">
