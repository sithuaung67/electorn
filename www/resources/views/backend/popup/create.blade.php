                ...
                <div class="col-md-9">
                  <div class="kt-portlet">
                   <div class="kt-portlet__head">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.popup.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      <div class="kt-portlet__body">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Body</label>
                            <textarea class="form-control" name="body" aria-describedby="" placeholder="" style="height: 150px;" value="{{ old('body') }}"></textarea>
