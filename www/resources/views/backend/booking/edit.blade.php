                ...
                <div class="col-md-10">
                  <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-label">
                          <a href="{{ route('admin.booking_edit.view',$booking->booking_id) }}"><i class="fa fa-angle-double-left"></i> Back to <span>lists</span>
                          </a>
                        </div>
                    </div>
                      ...
                      <div class="kt-portlet__body">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  <a href="{{ route('admin.booking_edit.view',$booking->booking_id) }}" class="btn btn-secondary form-control">Cancel</a>
                                </div>
