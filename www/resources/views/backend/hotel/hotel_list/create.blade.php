...
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
  ...
  <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="row justify-content-center">
      <form class="kt-form" action="{{ route('admin.hotel.store') }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-md-8">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="hotel_name" id="hotel_name" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('hotel_name') }}" required="required">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="address_mm" id="address_mm" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('address_mm') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="address_en" id="address_en" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('address_en') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="contact_info_mm" id="contact_info_mm" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('contact_info_mm') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="contact_info_en" id="contact_info_en" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('contact_info_en') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="policy_mm" id="policy_mm" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('policy_mm') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="policy_en" id="policy_en" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('policy_en') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="note_mm" id="note_mm" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('note_mm') }}"></textarea>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="note_en" id="note_en" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('note_en') }}"></textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="hotel_rating" id="hotel_rating" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('hotel_rating') }}" required="required">
          ...
          <div class="col-md-12">
            <div class="kt-portlet">
              <div class="kt-portlet__head">
                <div class="kt-portlet__head-label"><h3 class="kt-portlet__head-title">HOTEL IMAGE UPLOAD</h3></div>
              </div>
              <div class="kt-portlet__body">
                <div class="row">
                  <div class="container">
                    <fieldset class="form-group">
                      <label>Upload (Allow Multiple / no select each image) <a href="javascript:void(0)" class="custom-file-container__image-clear" id="clear_image" title="Clear Image"> ClearImage (not allow one clear)</a></label> <span style="color: #CD1717;font-weight:700;">*</span>
  ...
  $(document).ready(function () {
    $('#state_id').on('change', function(){
            ...
            if(id){
                $.ajax({
                    type: 'get',
                    url: '/admin/hotel/list/'+id,
                    success: function(data){ 
                        console.log(data);
                        $('#city_id').append(`<option value="">Select Township</option>`);
                        $.each(data, function(index,value) {
                            $('#city_id').append('<option value='+value.city_id+'>'+value.township+'</option>');
                        });
                    }
                });  
            }    
