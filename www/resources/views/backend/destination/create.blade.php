                ...
                <div class="col-md-10">
                  <div class="kt-portlet">
                   <div class="kt-portlet__head">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.destination.store') }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      <div class="kt-portlet__body">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control" name="destination_name" id="destination_name" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('destination_name') }}" required="required">
