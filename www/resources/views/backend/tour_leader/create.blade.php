...
@endsection
@section('title','Tour Leader Create')
@section('content')
                ...
                <div class="col-md-10">
                  <div class="kt-portlet">
                   <div class="kt-portlet__head">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.tour_leader.store') }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      <div class="kt-portlet__body">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tour_user_name" id="tour_user_name" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('tour_user_name') }}" required="required">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="password" id="password" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('password') }}" required="required">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="contact_phone" id="contact_phone" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('contact_phone') }}" required="required">
