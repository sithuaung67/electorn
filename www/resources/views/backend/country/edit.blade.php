              ...
              <div class="row justify-content-center">
                <div class="col-md-10">
                  <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.country.update',$country->country_id) }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      @method('post')
                      <div class="kt-portlet__body">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control" name="country_name" id="country_name" aria-describedby="" placeholder="" style="height: auto;" value="{{ $country->country_name }}">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label>Image</label>
                            <input type="file" class="form-control" name="country_image" id="country_image" aria-describedby="" placeholder="" style="height: auto;" value="{{ old('country_image') }}" onchange="loadFileOne(event)">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <img id="image_one" src="../../../../uploads/country/{{$country->country_image}}" width="100%" height="200" />
                          </div>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
