...
@endsection
@section('title','Package Image View')
@section('content')
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
               	<a href="" class="kt-subheader__breadcrumbs-link">Package Image </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                  ...
                  <div class="kt-portlet">
                   <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                          <h3 class="kt-portlet__head-title">Portrait Image View</h3>
                        </div>
                        <div class="kt-portlet__head-label">
                    	...
                    	<div class="row">
				                <div class="col-md-12">
				                  <div class="form-group">     
				                    @if($package->portrait_image)
                              <img id="image_four" src="../../../../uploads/package/{{$package->portrait_image}}" style="width: 100%;height: 300px;" />
                            @else
                              <img id="image_four" src="{{asset('photo.jpeg')}}" style="width: 100%;height: 250px;" />
                            @endif
                            <a href="{{ route('admin.portrait_image.edit',$package->package_id) }}" class="btn btn-outline-primary btn-sm mt-1" style="margin-right: -5px !important;"><i class="fa fa-edit" style="margin: 10px -6px 10px 0px !important;"></i></a>
				                  </div>
				                </div>
                    	</div>
                	  </div>
              ...
              <div class="row justify-content-center">
                <div class="col-md-10">
                  <div class="kt-portlet">
                   <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                          <h3 class="kt-portlet__head-title">Package Image View</h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                      <div class="row">
                        @foreach($package_images as $image)
                          @if($image->package_id==$package->package_id) 
                            <div class="col-md-6">
                                <div class="form-group">
                                    <img id="image_four" src="../../../../uploads/package/{{$image->image}}" style="width: 100%;height: 220px;" />
                                    <a href="{{ route('admin.image.edit',$image->package_image_id) }}" class="btn btn-outline-primary btn-sm mt-1" style="margin-right: -5px !important;"><i class="fa fa-edit" style="margin: 10px -6px 10px 0px !important;"></i></a>
                                    <form  action="{{ route('admin.image.destroy',$image->package_image_id) }}" method="post" onclick="return confirm('Do you want to delete this item?')" style="display: inline;">
                        @csrf
                        @method('delete')                                      
                ...
                <div class="col-md-10">
                  <div class="kt-portlet">
                   <div class="kt-portlet__head">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ route('admin.image.store',$package->package_id) }}" method="POST"  autocomplete="off" enctype="multipart/form-data">
                      @csrf
                      <div class="kt-portlet__body">
                        <div class="row">
                        <div class="container">
